...
if (!empty($_POST['reponse'])){
    if (!password_verify(htmlentities(preg_replace(LOWER($_POST['reponse']))),$deviner)){
...
?>
    ...
    <div align="center">
        ...
        <img class="mb-4" src="<?php echo $photo ?>" alt="" width="<?php echo $width ?>" height="<?php echo $height ?>">
    ...
    <div class="container">
        <form action="" class="justify-content-center" method="post">
        	<div class="form-group ">
        			<input class="form-control" type="text" name="reponse" placeholder="Votre Réponse">
            </div>
